...
def load_strategy_params():
    ...
    return StrategyParams(
        min_confluence=data.get("min_confluence", 4),
        ...
        require_confirmation_for_active=data.get("require_confirmation_for_active", False),
        require_rr_for_active=data.get("require_rr_for_active", False),
        ...
        sr_proximity_pct=data.get("sr_proximity_pct", 0.02),
        ...
        displacement_atr_mult=data.get("displacement_atr_mult", 1.5),
        use_candle_rejection=data.get("use_candle_rejection", False),
        use_momentum_filter=data.get("use_momentum_filter", False),
        momentum_lookback=data.get("momentum_lookback", 10),
        use_mean_reversion=data.get("use_mean_reversion", False),
        ml_min_prob=data.get("ml_min_prob", 0.6),
        ...
        fib_range_target=data.get("fib_range_target", 0.786),
        trend_min_confluence=data.get("trend_min_confluence", 4),
        partial_exit_at_1r=data.get("partial_exit_at_1r", True),
        partial_exit_pct=data.get("partial_exit_pct", 0.50),
        atr_trail_multiplier=data.get("atr_trail_multiplier", 1.5),
        use_adx_regime_filter=data.get("use_adx_regime_filter", False),
        use_adx_slope_rising=data.get("use_adx_slope_rising", False),
        use_fib_0786_only=data.get("use_fib_0786_only", False),
        use_market_structure_bos_only=data.get("use_market_structure_bos_only", False),
    )
